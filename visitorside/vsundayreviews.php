...
$sun_reviews_endpoint = "http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/api/api.php?sunday_reviews";
$display_reviews = file_get_contents($sun_reviews_endpoint);
...
<div class="nav-scroller" class="parent">
        <nav class="nav d-flex justify-content-between">
            <ul>
                ...
                <li> <a style="color:black" class="p-2 link-secondary" href="http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/visitorside/vsundayreviews.php?sunday_reviews">Sunday Reviews</a></li>
