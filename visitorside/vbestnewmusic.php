...
$best_new_reviews_endpoint = "http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/api/api.php?best_new_music";
$display_reviews = file_get_contents($best_new_reviews_endpoint);
...
<head>
    <title> SoundTribe | Best New Music </title>
    <meta charset="utf-8">
...
<div class="nav-scroller" class="parent">
        <nav class="nav d-flex justify-content-between">
            <ul>
                ...
                <li> <a style="color:black" class="p-2 link-secondary" href="http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/visitorside/vbestnewmusic.php?best_new_music">Best New Music</a></li>
