...
$reviews_endpoint = "http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/api/api.php?showreviews";
$display_reviews = file_get_contents($reviews_endpoint);
...
<div class="nav-scroller" class="parent">
        <nav class="nav d-flex justify-content-between">
            <ul>
                <li> <a style="color:black" class="p-2 link-secondary" id="current-page" href="http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/visitorside/homepage2.php?showreviews">Reviews</a>
                </li>
                ...
                <li> <a class="p-2 link-secondary" href="http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/visitorside/vclassic.php?classic_reviews">Classics</a></li>
             </ul>
        </nav>
        ...
        <div class="row row-col-6">
            ...
            <?php
                 foreach ($resultReviews as $row) {
                    echo " <div class='col'>
                <div id='album-image'>
                    <a href='http://lservice01.lampt.eeecs.qub.ac.uk/40312791_project/visitorside/reviewarticle.php?article_id={$row['ArticleID']}'></a><img src='{$row['AlbumImgUrl']}'></a>
                </div>
