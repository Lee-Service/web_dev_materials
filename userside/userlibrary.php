...
<head>
    <title> SoundTribe | UserLibrary </title>
    <meta charset="utf-8">
...
<?php
    ...
    <div class="header text-center">
        <img id="readingdino" src="../images/cooldino.jpg" />
        <h1>{USERNAMES} Article Library</h1>
        <p> Your favourited articles are saved here for your reading pleasure.</p>
    </div>
    <div class="container">
        <hr>
    </div>
